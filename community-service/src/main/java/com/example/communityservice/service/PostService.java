...
public class PostService {
    ...
    public Page<PostResponse> getPosts(Long userId, PostCategory category, Boolean isSolved, Pageable pageable) {
        return postRepository.searchPosts(userId, category, isSolved, pageable);
    }
