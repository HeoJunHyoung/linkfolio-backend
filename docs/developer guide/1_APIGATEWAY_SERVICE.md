...
- `community-service-route`: `/community-service/**` 경로의 WebSocket 요청을 `http://community-service:80`으로 전달한다.
- `support-service-route`: `/support-service/**` 경로의 WebSocket 요청을 `http://support-service:80`으로 전달한다.
